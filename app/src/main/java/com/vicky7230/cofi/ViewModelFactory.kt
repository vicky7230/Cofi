...
import com.vicky7230.cofi.ui.coffeeShops.CoffeeShopsViewModel
...
class ViewModelFactory private constructor(private val application: Application, private val dataManager: DataManager) : ViewModelProvider.NewInstanceFactory() {
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>) =
            with(modelClass) {
                when {
                    isAssignableFrom(CoffeeShopsViewModel::class.java) ->
                        CoffeeShopsViewModel(application, dataManager)
                    else ->
